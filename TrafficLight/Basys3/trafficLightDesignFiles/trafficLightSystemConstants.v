...
parameter real NORMAL_MODE_MINIMUM_GREEN_LIGHT_SIGNAL_TIME_SEC = 10; // [sec] - dwell time in green light state for both primary and secondary roads (normal mode)
...
parameter real NORMAL_MODE_MINIMUM_BOTH_LANE_RED_TIME_SEC = 10;  // [sec] - dwell time in red light state for both primary and secondary roads  (normal mode)

parameter real FLASHING_MODE_MINIMUM_BOTH_RED_TIME_SEC = 10; // [sec] - dwell time in init state in flashing mode
parameter real FLASHING_MODE_MINIMUM_BOTH_OFF_TIME_SEC = 5; // [sec] - dwell time in both roads off in flashing mode
parameter real FLASHING_MODE_MINIMUM_PRI_YELLOW_SEC_RED_TIME_SEC = 5; // [sec] - dwell time when primary road flashes yellow secondary road flashes red
